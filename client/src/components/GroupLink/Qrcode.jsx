...
const Qrcode = () => {
  const [groupLink] = useState(
    "https://chat.whatsapp.com/Bh0fwescrTw62MH8iKTU9f"
  );

  return (
    <div className="modal modal-open">
      <div className="modal-box p-0">
        <div className="flex justify-between text-primary-content items-center p-4 shadow-lg bg-primary">
        ...
        <div className="flex flex-col items-center justify-center p-2 space-y-2">
          ...
          <div className="text-center">
            <h2 className="text-xl font-medium">Hackathon</h2>
